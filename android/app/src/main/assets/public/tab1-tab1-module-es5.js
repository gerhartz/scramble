(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab1-tab1-module"], {
        ...
        _createClass(Tab1Page, [{
          ...
          value: function filterMountains() {
            ...
            this.filteredMountains = this.mountains.filter(function (mountain) {
              ...
              var mountainState = mountain.state;

              if (_this3.selectedStates[0] == true) {
                // any state will do
                stateMatch = true;
              } else {
                if (mountainState == 'AK' && _this3.selectedStates[1] == true) {
                  stateMatch = true;
                } else if (mountainState == 'CA' && _this3.selectedStates[2] == true) {
                  stateMatch = true;
                } else if (mountainState == 'CO' && _this3.selectedStates[3] == true) {
                  stateMatch = true;
                } else if (mountainState == 'WA' && _this3.selectedStates[4] == true) {
                  stateMatch = true;
                }
              }
    ...
    function tmrb(module, __webpack_exports__, __webpack_require__) {
      ...
      var _modals_resource_modal_resource_modal_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
